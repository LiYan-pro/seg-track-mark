...
segtracker_args = {
    """
    'sam_gap': 2000,  # the interval to run sam to segment new objects
    'min_area': 1000,  # minimal mask area to add a new mask as a new object
    'max_obj_num': 1,  # maximal object number to track in a video
    'min_new_obj_iou': 0.01, # the background area ratio of a new object should > 80%
    """
