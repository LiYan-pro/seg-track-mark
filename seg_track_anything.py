...
aot_model2ckpt = {
    "deaotb": f'{os.path.join(os.path.abspath(__file__), "ckpt")}/DeAOTB_PRE_YTB_DAV.pth',
    "deaotl": f'{os.path.join(os.path.abspath(__file__), "ckpt")}/DeAOTL_PRE_YTB_DAV',
    "r50_deaotl": f'{os.path.join(os.path.abspath(__file__), "ckpt")}/R50_DeAOTL_PRE_YTB_DAV.pth',
}
...
def tracking_objects_in_video(SegTracker, input_video):
    ...
    io_args = {
        ...
        'output_mask_dir': f'{os.path.join(os.path.abspath(__file__))}/../results/{video_name}_masks',
        'output_video': f'{os.path.join(os.path.abspath(__file__))}/../results/{video_name}_track.mp4',
        'output_gif': f'{os.path.join(os.path.abspath(__file__))}/../results/{video_name}_track.gif',
    }
