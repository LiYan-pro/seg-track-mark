...
input_dir = 'D:/code/samt_v01/test_img'
input_video = 'D:/code/samt_v01/test.mp4'
filename = 'test.mp4'
output_dir = 'D:/code/samt_v01/test_img/02.jpg'
...
# 创建sam模型
sam = sam_model_registry["vit_b"](checkpoint="D:/code/samt_v01/sam_vit_b_01ec64.pth")
...
while True:
    ...
    while True:
        ...
        # todo 考虑如何把这个位置的input_point和input_label输出
            ...
            if len(input_point) > 0 and len(input_label) > 0:
                ...
                while (1):
                    ...
                    mask_info = f'Total: {num_masks} | Current: {mask_idx} | Score: {scores[mask_idx]:.2f} ' \
                                f'| Press w to confirm | Press d to next mask | Press a to previous mask ' \
                                f'| Press q to remove last point | Press s to save'
